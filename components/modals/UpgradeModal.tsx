...
const plans = [
  {
    ...
    price: 19,
    credits: 1500,
    label: "For freelancers & developers",
    features: ["1,500 credits/month", "Unlimited projects", "React + Tailwind export", "Flow Map & Design System", "AI visual editing"],
    popular: true,
  },
  {
    id: "agency",
    ...
    price: 99,
    credits: 15000,
    label: "For teams & dev shops",
    features: ["15,000 credits/month", "5 team members", "Shared Design System", "Priority GPU processing"],
    popular: false,
  },
];
