...
export async function transmuteVideoToCode(options: TransmuteOptions): Promise<TransmuteResult> {
  ...
  const isRetryableError = (error: any) => {
    ...
    return msg.includes('500') || msg.includes('Internal Server Error') || msg.includes('503') || msg.includes('overloaded') || msg.includes('Service Unavailable') || msg.includes('429') || msg.includes('rate limit') || msg.includes('timed out') || msg.includes('Failed to parse');
  };
