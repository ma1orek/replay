                ...
                {DEMOS.map((demo, index) => (
                  ...
                  >
                    ...
                    <div className="relative aspect-[16/10] w-full overflow-hidden rounded-t-xl">
                      ...
                      {/* Tag on video - Dark background with white text */}
                      <div className="absolute top-3 left-3">
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-[9px] font-semibold uppercase tracking-wider bg-black/90 border border-white/10 text-white">
                          {demo.tag}
                        </span>
                      </div>
