      ...
      <div className="max-w-6xl mx-auto px-6 py-8 lg:py-12">
        <div className="lg:grid lg:grid-cols-[1fr_280px] lg:gap-12">
          ...
          <article>
            ...
            {/* Title - no motion for SEO (H1 must be visible immediately) */}
            <h1
            ...
            {/* Author & Share - no motion for SEO */}
            <div
            ...
            {/* Content - no motion for SEO (article body must be indexed) */}
            <div
            ...
            {/* Bottom CTA - can keep motion, not critical for SEO */}
            <motion.div
