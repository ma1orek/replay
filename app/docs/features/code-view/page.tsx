    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-xl bg-[#1a1a1a] border border-white/10 font-mono text-sm overflow-x-auto">
          <pre className="text-white/70">{`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
