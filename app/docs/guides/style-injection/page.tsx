...
import { Sparkles, Wand2, Check, Layers } from "lucide-react";
    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {STYLE_CATEGORIES.map((cat) => (
            <span key={cat.name} className={`px-3 py-1.5 rounded-lg text-xs bg-zinc-800/50 border border-zinc-700 ${cat.color}`}>
              {cat.name}
            </span>
          ))}
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          {FEATURED_STYLES.map((style) => (
            <div key={style.name} className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700">
            ...
            <div key={category}>
              ...
              <div className="grid md:grid-cols-3 gap-2">
                {ALL_STYLES.filter(s => s.category === category).map((style) => (
                  <div key={style.name} className="p-3 rounded-lg bg-zinc-800/50 border border-zinc-700">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-700 font-mono text-sm">
          <p className="text-zinc-300">"Apple-style with frosted glass and smooth animations"</p>
          <p className="text-zinc-300 mt-2">"Dark mode like Linear with subtle glow effects"</p>
          <p className="text-zinc-300 mt-2">"Colorful gradients like Stripe's landing page"</p>
          <p className="text-zinc-300 mt-2">"Minimalist Notion-style with clean typography"</p>
          <p className="text-zinc-300 mt-2">"Glassmorphism with vibrant mesh backgrounds"</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-medium text-emerald-400">Changes:</h4>
            </div>
        ...
        <div className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700">
          <ul className="space-y-2 text-sm text-zinc-400">
            <li className="flex items-start gap-2">
              <Wand2 className="w-4 h-4 text-zinc-500 mt-0.5" />
