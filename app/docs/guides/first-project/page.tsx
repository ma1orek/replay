    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 text-sm text-zinc-500">
          ...
          <span>Guides</span>
          <span>/</span>
          <span className="text-zinc-900">First Project</span>
        </div>
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl bg-[#FF6E3C]/20">
            <FileVideo className="w-6 h-6 text-[#FF6E3C]" />
          </div>
          <h1 className="text-4xl font-bold text-zinc-900">Create Your First Project</h1>
        </div>
      ...
      {/* Prerequisites */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-900">Before You Start</h2>
      ...
      {/* Recording tips */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-900">Recording Tips</h2>
      ...
      {/* Steps */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-900">Step by Step</h2>
        <div className="space-y-4">
          {[
            {
              step: 1,
      ...
      {/* What's next */}
      <div className="space-y-4">
        <h2 className="text-2xl font-semibold text-zinc-900">What's Next?</h2>
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/docs/features/edit-with-ai" className="p-4 rounded-xl bg-zinc-100 border border-zinc-200 hover:border-[#FF6E3C]/50 transition-colors group">
            <h4 className="font-medium text-zinc-900 mb-1 flex items-center gap-2">
              Edit with AI
              <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            </h4>
            <p className="text-sm text-zinc-500">Modify and add new pages to your project</p>
          </Link>
          <Link href="/docs/features/publish" className="p-4 rounded-xl bg-zinc-100 border border-zinc-200 hover:border-[#FF6E3C]/50 transition-colors group">
            <h4 className="font-medium text-zinc-900 mb-1 flex items-center gap-2">
              Publish
              <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            </h4>
            <p className="text-sm text-zinc-500">Deploy your UI to a live URL</p>
          </Link>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-xl bg-zinc-100 border border-zinc-200">
            <h4 className="font-medium text-zinc-900 mb-1">Generation Failed?</h4>
            <p className="text-sm text-zinc-500">Try a shorter video or check your internet connection. Complex animations may cause issues.</p>
          </div>
          <div className="p-4 rounded-xl bg-zinc-100 border border-zinc-200">
            <h4 className="font-medium text-zinc-900 mb-1">UI Looks Different?</h4>
            <p className="text-sm text-zinc-500">Use Edit with AI to refine colors, fonts, or layout. The AI interprets - it doesn't pixel-perfect copy.</p>
          </div>
        </div>
      </div>
    </div>
