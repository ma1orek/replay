  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
            <h4 className="font-medium text-emerald-400 mb-2">Do:</h4>
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link href="/docs/features/edit-with-ai" className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors group">
            <h4 className="font-medium text-white mb-1 flex items-center gap-2">
              Edit with AI
              <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            </h4>
            <p className="text-sm text-zinc-400">Modify and add new pages to your project</p>
          </Link>
          <Link href="/docs/features/publish" className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700 hover:border-zinc-600 transition-colors group">
            <h4 className="font-medium text-white mb-1 flex items-center gap-2">
              Publish
              <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            </h4>
            <p className="text-sm text-zinc-400">Deploy your UI to a live URL</p>
          </Link>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700">
            ...
            <p className="text-sm text-zinc-400">Try a shorter video or check your internet connection. Complex animations may cause issues.</p>
          </div>
          <div className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700">
            <h4 className="font-medium text-white mb-1">UI Looks Different?</h4>
            <p className="text-sm text-zinc-400">Use Edit with AI to refine colors, fonts, or layout. The AI interprets - it doesn't pixel-perfect copy.</p>
          </div>
        </div>
      </div>
    </div>
